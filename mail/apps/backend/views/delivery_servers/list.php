        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php $box = BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add(HtmlHelper::accessLink(IconHelper::make('export') . Yii::t('app', 'Export'), array('delivery_servers/export'), array('class' => 'btn btn-primary btn-flat', 'title' => Yii::t('app', 'Export'))))
